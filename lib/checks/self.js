...
module.exports = class Self extends Check {
    constructor(config) {
        ...
        this.secondsToKeepMemoryLeakMsg = this.config.secondsToKeepMemoryLeakMsg || constants.DEFAULT_SECONDS_TO_KEEP_MEMORY_LEAK_MSG;
        if (this.config.memwatch) {
            console.log('ACTIVATED MEMWATCH!!');
