...
module.exports = class Self extends Check {
    constructor(config) {
        ...
        this.metrics = config.metrics || Object.assign({}, constants.DEFAULT_METRICS_LIMITS);
        this.secondsToKeepMemoryLeakMsg = config.secondsToKeepMemoryLeakMsg || constants.DEFAULT_SECONDS_TO_KEEP_MEMORY_LEAK_MSG;
    ...
    async getStats() {
        const stats = {
            memoryUsage: Math.round(100 * os.freememPercentage()),
